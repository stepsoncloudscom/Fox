...
**Son güncelleme: 25 Ağustos 2026** *(SOC'ye dönüş — canlı durum ölçüldü, aksiyon planı kuruldu)*
...
| **Steps On Clouds** (kendi marka) | 🔴 **ölçüldü 25 Ağu:** canlıda yanlış bilgi (geçmiş etkinlikler "yaklaşan"+kayıt açık) · blog 10 ay ölü · ticari kol yok · Faz 1-5 üretimi stokta | Blok 0 (etkinlik arşivi + hero + mağaza kararı) & Blok 3 (GSC) — Wix oturumu gerek. Plan: `raporlar/soc-durum-ve-aksiyon-plani-2026-08.md` | Ayhan + Fox |
...
4. 🔴 **SOC — 4 karar:** Wix Editör oturumu hangi gün · mağaza mekanizması (76 gündür açık) · hero slogan (reddedileni hâlâ canlı) · ticari kol adı + fiyat kademeleri.
...
- 🔴 **SOC'de aynı hastalık — yayın kası yok:** 5 fazlık üretim `raporlar/`'da, canlı sitede Haziran'dan beri değişiklik yok. Ayrıca 2 Empati Koşusu yapıldı, **hiç kayıt tutulmadı** → misyon kanıtı buharlaştı (Kayıt Protokolü v1 kurulacak).
- ⚠️ **Medikal içerikte uydurma sıfır toleransı:** TİTCK + YMYL. Teyitsiz veri yumuşatılmaz, çıkarılır.
- ⚠️ **Levitate görsel + IP:** düzeltme turu görmedi (Forever/Blade logo kalıntısı ihtimali — canlıya çıkmadan bakılmalı); üretici görselinden marka silme (telif/debranding) + TİTCK-marka hukuku çekişmesi → avukat sorusu açık.
