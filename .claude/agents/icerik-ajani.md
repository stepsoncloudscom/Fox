...
- **Görsel parmak izi zemini:** `fox-gorsel-parmak-izi.md` — sıcak palet, atmosferik ışık, editorial mood, güçlü figür. Brief bunu tarif eder (düz ürün ışığı isteme).
...
## ONUR MERKEZLİ TEMSİL (kritik)
Ampüte/engelli/sosyal etki içeriğinde: acıma YOK, ilham pornosu YOK. Güç, fail (özne olma), gündelik gerçeklik. Aynı editorial kalite — "engelli içeriği" diye kalite düşmez.

---

## DİL
Türkçe + İngilizce, müşteriye/hedefe göre. Türkçe metin PDF'te Arial Unicode (pdf-motoru.py). Türkçe karakter hatası = kalite ihlali.
...
- **Kuzey Yıldızı:** İçerik marka değerini artırmaya, kanıtlanabilir etkiye hizmet eder.
