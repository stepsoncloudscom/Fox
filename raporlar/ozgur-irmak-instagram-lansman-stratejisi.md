# Özgür Irmak — Instagram Dönüş Serisi (İlk Hafta / 4-5 Post) Strateji Notları
*Fox · 11 Temmuz 2026 · Kaynak: Ayhan'ın strateji sohbet notları (11 Tem) · İÇ TASLAK — Denetmen + avukat gate'i geçmeden hiçbir metin yayınlanmaz*
*Zemin: `ozgur-irmak-marka-kimligi-v01.md` (§1.4, §2.3, §2.4) · `marka-bulutu-os-medikal-protez-bagi.md` (A.2, A.3, avukat soruları) · `ozgur-irmak-uyumlu-ticaret-plani.md`*

---

## 1 · Ayhan'ın kilitlediği parametreler (notlardan damıtıldı)

| Parametre | Karar |
|---|---|
| **Yay (arc)** | Yumuşak başlangıç → 1 hafta / 4-5 post sonunda "Protez sektöründe neler oluyor?" sorusuna varış. İlk 2-3 post sıcak + merak uyandırıcı; eleştirel ton kademeli girer. |
| **İlk post duygusu** | "Sizi yeniden görmek güzel." |
| **İlk post kimliği** | Kısa bir ara vermiş, **yenilenmiş bir ekip** (uzun süredir görüşülmeyen tanıdık değil). Aranın nedenine girilmez — "yenilendik, buradayız" düzeyi. |
| **Karakter** | Samimi ama eleştirel. Sektörü içeriden bilen, zor soruları açan, kullanıcıyı konuşmaya dahil eden. Kişi olarak: sakin, dikkatli, çözüm odaklı, teknik bilgisi güçlü ama gösterişsiz, dinleyen, cesaret veren, birlikte yol bulan. *(Kimlik §1.4 ile birebir örtüşür: Usta / Çağdaş / İnsan-merkezli / Dingin.)* |
| **Eleştiri biçimi** | İsim vermeden **sistem eleştirisi**; kişi/kurum hedef alınmaz. Üç pozisyondan birden: ① "Sektörün içindeyiz, bazı şeylerin değişmesi gerek" ② "Kullanıcıların uzun süredir sorduğu soruları açıkça konuşuyoruz" ③ "Biz de bu sistemin parçasıyız; kendimizi de sorguluyoruz." |
| **Konu ağırlığı** | 5 başlığın hepsi: fiyatlar/şeffaflık · kullanıcı sorunları · klinik/uzman tabuları · teknoloji · beden & toplumsal algı. |
| **Şeffaflık taahhüdü** | Marka kendi uygulamalarını da açacak: fiyatlandırma mantığı, ürün seçimi, teslim sonrası destek, geri bildirim. |
| **Ton tavanı** | "Protez sektöründe yıllardır konuşulmayan bazı şeyler var. Üstelik biz de bu sistemin parçasıyız." — çizgiye yakın, tavan bu civarda. |
| **Dil** | "Biz" anlatıcı · takipçiye temel hitap "sen", topluluğa/sektöre seslenirken yer yer "siz". |
| **Sistem modeli** | Marka = kişi/karakter; interaktif sistem. Bilgi vermez konuşur; karar vermez seçenek sunar; anlatmaz soru sorar; takipçi izleyici değil hikâyenin karakteri. Patagonia daveti referans: "Bu hikâyede izleyici değilsin." |
...
- **Uyumlu yan:** Karakter tanımı, "birlikte" dili, sen hitabı, soru soran yapı — kimliğin §1.4 kişiliği ve §2.3/3 "birlikte dili" ile tam uyumlu. Merak kurgusu ("Son dönemin en büyük sorusu?") dinginlik kuralıyla çelişmez; aciliyet/kampanya diline kaymadığı sürece yeşil kuşakta kalabilir.
