...
- **Şerit B** (ajanslar): işlenen son = ArtArda Reklam (ARŞİV, Ankara). ⚠️ **B havuzu TÜKENDI.** Tüm B adayları işlendi. Pazartesi besleme: dijitalajanslar.com yeni tarama gerekiyor (önceki taramada moda odaklı ajans çıkmamıştı — yeni filtre dene).
- **Şerit C1** (Who's Next Paris): işlenen son = BASARIN LEATHER & FUR (29 Haz). **⭐ C1 COOLDOWN BİTİYOR: 2026-07-08'den itibaren şu markalar yeniden aday:** MARGITTES / FONEM / DOLCEZZA / SOFISA / NILMARK / YXL COLLECTION / L'ATELIER DE GAIA / MON REVE / MILOU JEWELRY / BIRELIN / CLANDE / LAMANTE / PUNKQUEEN / HİSSET / TERZİ DÜKKANI (15 marka — kanal/iletişim yeniden dene, bazıları form/IG DM alternatifi olabilir).
- **Şerit C2** (IFCO): işlenen son = CARDUCCI (5 Tem). **C2 IFCO Şubat 2026 listesi TAMAMLANDI** — tüm adaylar işlendi (ICP uyumsuz / doğrulanamadı ağırlıklı). Ağustos 2026 IFCO (19-21 Ağu) için yeni katılımcı listesi yayınlanınca taranacak. MİANOTTE/AHSEN/HALE AKKESE cooldown: 2026-07-12.
- **Pazartesi besleme kaynak sırası** (dönüşümlü): dijitalajanslar.com → İHKİB/fuar duyuruları → Bigumigu/MediaCat yeni iş haberleri → *(başa dön)*. Sıradaki = dijitalajanslar.com *(yeni filtre: moda/e-ticaret müşteri sinyali olan butik ajanslar)*.
- **Kritik yaklaşan tarihler:** C1 cooldown bitiyor: 2026-07-08 (15 marka yeniden denenebilir). Esti Living görüşmesi: 14 Tem 2026. IFCO Ağustos 2026 fuarı: 19-21 Ağu (yeni liste için hazırlık).
