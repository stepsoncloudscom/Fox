# Beymen Taslak — Brief
*Yöntem: Ayhan doneleri parça parça verir → "bitti" → varyasyon üretilir → tek tek onaylanır. Üst-segment outreach, analiz-temelli, zamana yayılır.*
*REGISTER (kilitli): Beymen üst segment — ölçülü, rafine, ağırlığı olan dil. Lakayıt / fazla-samimi / "peşinen söyleyeyim" tonu YASAK.*
*MARKA MİMARİSİ (sabit — bir daha sorma): **Steps on Clouds = yaratıcı yönetim ajansı** (üst marka). **Marka Bulutu = ajansın sistemi/yaklaşımı.** **Ayhan Erden = kurucu / yaratıcı yön.** **Fox = yapay zekâ ajanımız** (hız+ölçek; ruh/karar insanda). İmza: Ayhan Erden, Kurucu — Steps on Clouds.*

## Anlatı omurgası
Ayhan Erden + global deneyim → Steps on Clouds (yaratıcı yönetim ajansı) + insan-odaklılık → Marka Bulutu sistemi → çekirdek değer: görsel dilin pazarlamaya + hikâyeye dönüşümü. İnsan+AI: ruh/karar insanda, hız/ölçek Fox'ta.

## Onaylı yön: V1+V3 harman
Açılış MARKA-ÖNCE (önce marka, sonra biz). AI-çağı + Fox hafif dokunuş (V3) + ortak yaratım teklifi, markanın kendi hassasiyeti ekseninde (V1). İnsan önceliği korunur.

## Tema vurguları (gövdede, markaya göre dozla)
- Yapay zekânın hızı × insanın ruhu (ruh insanda)
- **Adaptif moda = kapsayıcı/erişilebilir "adaptive fashion"** (SoC insan-odaklı DNA). ⚠️ ONUR MERKEZLİ (§9): acıma/ilham pornosu yok. Kategoriye göre: giyim/mayoda doğrudan; takı/objet/çantada "insan ruhu / dokunduğu yer" üzerinden.
- Hikâye anlatımının önemi
- Herkesleşmeye karşı markanın kendi sesi + "dokunduğu yer"

## Özelleştirme & tempo
- Her mail markaya özel ANALİZ'den doğar (görsel dünya, konum, kendi hassasiyeti, açıklar) — yüzeysel değil.
- Zamana yayılır: topluca gönderim yok; marka-marka, ölçülü tempo.
- Akış: marka seç → analiz → şablonu uyarla → Ayhan onayı → sıradaki.

## Açık
- Künye: global deneyim şimdilik adsız ("global markalar… in-house stüdyo"). Össur/Hummel/Defacto açıkça anılsın mı? — Ayhan kararı.

---

## ✅ ONAYLI METİN — Mehry Mu (Ayhan onayladı, 26 Haz)
**Konu:** Mehry Mu × Steps on Clouds — bir ortak yaratım önerisi

Sayın Mehry Mu Ekibi,

Bir markayı marka yapan şeyin "üretebilmek" değil "dokunabilmek" olduğu bir döneme giriyoruz. Mehry Mu'nun duruşu tam da bu yüzden kalıcı: el emeği ve zanaatkârın izi, herkesleşmenin içinde sizi ayıran şey.
...
Mehry Mu'ya önerimiz bir ortak yaratımdır: markanın kendi hassasiyetini — zanaatın ve elin hikâyesini — sizin diliniz ve bizim yaratıcı yönümüzle ortak bir görsel anlatıya taşımak. Yapay zekânın hızı burada yalnızca o emeği görünür kılmanın aracıdır; yerine geçen değil.
...
*To: info@mehrymu.com · Gmail taslağı: gönderim partisinde oluşturulacak (eski 2 deneme Mehry Mu taslağı superseded → silinecek).*
...
**Konu:** {Marka} × Steps on Clouds — bir ortak yaratım önerisi

Sayın {Marka} Ekibi,

[**P1 — MARKAYA ÖZGÜ KANCA** (analizden): çağa dair bir gözlem + markanın o gözlemde durduğu özgün yer / onu ayıran nitelik. Marka-önce.]

Size bu nedenle yazıyoruz. Steps on Clouds, markaların görsel dilini pazarlama diline ve hikâyeye dönüştüren bir yaratıcı yönetim ajansıdır; bunu Marka Bulutu adını verdiğimiz sistemle yürütürüz. Kurucusu Ayhan Erden, global markaların görsel dünyalarını kurmuş bir isimdir. Üretimde insanın sezgisini yapay zekânın hızıyla birleştiririz: yön, sezgi ve ruh insanda; hız ve ölçek yapay zekâ ajanımız Fox'ta. Karar her zaman insanındır. **[SABİT]**

[**P3 — MARKAYA ÖZGÜ TEKLİF** (analizden): "{Marka}'ya önerimiz bir ortak yaratımdır: markanın kendi hassasiyetini — [markanın özü/hassasiyeti] — sizin diliniz ve bizim yaratıcı yönümüzle ortak bir görsel anlatıya taşımak. Yapay zekânın hızı burada yalnızca [o değeri] görünür kılmanın aracıdır; yerine geçen değil."]

Bu fikri sizinle paylaşmak üzere kısa bir görüşme talep ediyoruz; size uygun bir zaman dilimini paylaşmanız yeterli. **[SABİT]**
